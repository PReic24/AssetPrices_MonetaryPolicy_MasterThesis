                ...
                case {6,7,8}
                    switch(num_set.sfast)
                        case 6, % This is the case we mostly use
                            ...
                            step_size = (50 + splotu(1)) / 30; % Extracting a scalar from splotu
                            end_value = min(splotu) - (50 + splotu(1)) / 130; % Extracting a scalar from splotu

                            splot1 = -50:step_size:end_value;
                            % is_same = isequal(splot1, splot1_v1);
