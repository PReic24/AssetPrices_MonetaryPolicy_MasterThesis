%% (Pflueger) This class contains all parameters and methods related to the macro dynamics of the model
classdef macro_dyn
    properties
   ...
   methods
       ...
       function macro_dyn = update_params(macro_dyn)  
           ...
           macro_dyn.sigma_vec      = [9.0000e-06 9.0000e-06 macro_dyn.sigma_vec(3) 10^(-9)];  
